...
public class Message {
    ...
    public static String[] FEATURES_JSON = {"features", "geometry", "type", "Point", "coordinates", "properties", "ref", "entrance", "doors: ", "path"};
    ...
    public static String EXETENSIOM = ".png";
    public static String TO_MARKER = ".png";
    public static String COLOR_WALL = "#ffffff";
    public static String COLOR_PPATH = "#cb2c39";
